...
/*Size colour type */
allCards([planet(small, red, terrestrial), planet(small, green, terrestrial)
/*, planet(medium, green, terrestrial), planet(large, green, terrestrial), planet(medium, blue, terrestrial),
